...
public class SDMCreateAttachmentsHandlerTest {
  ...
  // This should be apadted as per changes in create flow
  private Map<String, String> secondaryProperties = new HashMap<>();
  ...
  public void testRenameWithNoAttachments() throws IOException {
    ...
    verify(sdmService, never())
        .renameAttachments(
            anyString(), any(SDMCredentials.class), any(CmisDocument.class), secondaryProperties);
  }
  ...
  public void testRenameWithRestrictedCharacters() throws IOException {
    ...
    when(sdmService.renameAttachments(
            anyString(), any(), any(CmisDocument.class), secondaryProperties))
  ...
  public void testWarnOnRestrictedCharacters() throws IOException {
    ...
    try (MockedStatic<SDMUtils> sdmUtilsMockedStatic = mockStatic(SDMUtils.class)) {
      ...
      when(sdmService.renameAttachments(
              any(String.class), any(), any(CmisDocument.class), secondaryProperties))
