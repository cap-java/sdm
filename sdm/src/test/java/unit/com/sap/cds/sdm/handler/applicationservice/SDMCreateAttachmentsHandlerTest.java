...
//           .when(() -> SDMUtils.isFileNameDuplicateInDrafts(data, "compositionName",
// "TestEntity"))
...
//       // Mock AttachmentsHandlerUtils.fetchAttachments to return the attachment with null
// filename
//       try (MockedStatic<AttachmentsHandlerUtils> attachmentsHandlerUtilsMocked =
//           mockStatic(AttachmentsHandlerUtils.class)) {
//         attachmentsHandlerUtilsMocked
...
//                 () ->
//                     handler.updateName(context, data, "compositionDefinition",
// "compositionName"));
