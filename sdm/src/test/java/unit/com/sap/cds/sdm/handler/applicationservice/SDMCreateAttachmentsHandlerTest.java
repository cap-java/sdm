...
//
//    handler =
//        spy(new SDMCreateAttachmentsHandler(persistenceService, sdmService, tokenHandler,
// dbQuery));
//
...
//
//      // Mock AttachmentsHandlerUtils.getAttachmentCompositionDetails to return the expected
// mapping
...
//          .when(
//              () ->
//                  SDMUtils.FileNameContainsRestrictedCharaters(anyList(), anyString(),
// anyString()))
...
//          .when(
//              () ->
//                  SDMUtils.FileNameDuplicateInDrafts(data, "compositionName", "TestEntity",
// "upId"))
...
//          .thenReturn(Optional.of(attachmentDraftEntity));
//
//      // Stub the validation helper methods so validateFileName runs and detects the restricted
// char
//      sdmUtilsMockedStatic
//          .when(() -> SDMUtils.FileNameContainsWhitespace(anyList(), anyString(), anyString()))
//          .thenReturn(Collections.emptySet());
...
//  //     verify(attachment2).replace("fileName", "file2_sdm.txt"); // This one has restricted
// chars
