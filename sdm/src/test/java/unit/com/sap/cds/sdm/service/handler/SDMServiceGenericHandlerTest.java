...
//
//    ArgumentCaptor<CopyAttachmentInput> captor =
// ArgumentCaptor.forClass(CopyAttachmentInput.class);
...
//        .thenReturn("10__null");
//    sdmUtilsMock.when(() ->
// SDMUtils.hasRestrictedCharactersInName(anyString())).thenReturn(false);
...
//        assertThrows(ServiceException.class, () -> sdmServiceGenericHandler.create(mockContext));
//    assertEquals(
//        SDMConstants.nameConstraintMessage(Collections.singletonList("test/URL")),
// ex.getMessage());
//  }
//
//  @Test
...
//    verify(dbQuery).getObjectIdForAttachmentID(eq(draftEntity), eq(persistenceService),
// eq("123"));
