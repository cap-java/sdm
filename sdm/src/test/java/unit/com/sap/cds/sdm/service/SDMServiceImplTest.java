...
// import
// com.sap.cds.feature.attachments.service.model.servicehandler.AttachmentMarkAsDeletedEventContext;
...
//            ServiceException.class,
//            () ->
//                sdmServiceImpl.createFolder("parentId", "repositoryId", mockSdmCredentials,
// false));
//
...
//        "{\"message\": \"Duplicate document found\", \"succinctProperties\": {\"cmis:objectId\":
// \"objectId\"}}";
//    CmisDocument cmisDocument = new CmisDocument();
//    cmisDocument.setFileName("sample.pdf");
//    cmisDocument.setAttachmentId("attachmentId");
...
//    String mockResponseBody =
//        "{\"succinctProperties\": {\"cmis:objectId\": \"objectId\"}, \"message\": \"Malware
// Service Exception: Virus found in the file!\"}";
//
//    CmisDocument cmisDocument = new CmisDocument();
//    cmisDocument.setFileName("sample.pdf");
//    cmisDocument.setAttachmentId("attachmentId");
...
//    when(response.getEntity()).thenReturn(entity);
//
//    MockResponse mockResponse1 = new
// MockResponse().setResponseCode(200).setBody("folderByPath123");
...
//    MockResponse mockResponse1 = new
// MockResponse().setResponseCode(200).setBody("newFolderId123");
//    mockWebServer.enqueue(mockResponse1);
//
...
//    when(statusLine.getStatusCode()).thenReturn(200);
//    when(response.getEntity()).thenReturn(entity);
//    InputStream inputStream = new ByteArrayInputStream("{\"message\":\"Server
// error\"}".getBytes());
//    when(entity.getContent()).thenReturn(inputStream);
//
//    SDMServiceImpl sdmServiceImpl = new SDMServiceImpl(binding, connectionPool, tokenHandler);
...
//    when(entity.getContent()).thenReturn(inputStream);
//
//    JSONObject result = sdmServiceImpl.getObject(objectId, sdmCredentials, false);
//    assertNotNull(result);
//    assertTrue(result.has("succinctProperties"));
//    JSONObject succinctProperties = result.getJSONObject("succinctProperties");
//    assertEquals("desiredObjectName", succinctProperties.getString("cmis:name"));
//  }
//
//  @Test
...
//    when(entity.getContent()).thenReturn(inputStream);
//
//    JSONObject objectName = sdmServiceImpl.getObject(objectId, sdmCredentials, false);
