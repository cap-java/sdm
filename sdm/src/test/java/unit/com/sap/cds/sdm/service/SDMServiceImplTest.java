...
//
//      SDMServiceImpl sdmServiceImpl = new SDMServiceImpl(binding, connectionPool, tokenHandler);
//      int actualResponse = sdmServiceImpl.deleteDocument("deleteTree", "objectId", anyString());
...
//
//      SDMServiceImpl sdmServiceImpl = new SDMServiceImpl(binding, connectionPool, tokenHandler);
//      int actualResponse = sdmServiceImpl.deleteDocument("delete", "objectId", anyString());
//      assertEquals(200, actualResponse);
//    } finally {
//      mockWebServer.shutdown();
//    }
...
//
//      SDMServiceImpl sdmServiceImpl = new SDMServiceImpl(binding, connectionPool, tokenHandler);
//      int actualResponse = sdmServiceImpl.deleteDocument("delete", "ewdwe", anyString());
...
//    assertThrows(
//        ServiceException.class, () -> sdmServiceImpl.deleteDocument("delete", "123",
// anyString()));
//  }
//
//  @Test
