...
//     // Simulate IOException during HTTP call
//     when(mockHttpClient.execute(any(HttpPost.class))).thenThrow(new IOException("Network
// error"));
...
//       when(tokenHandler.getHttpClient(any(), any(), any(),
// eq(grantType))).thenReturn(httpClient);
