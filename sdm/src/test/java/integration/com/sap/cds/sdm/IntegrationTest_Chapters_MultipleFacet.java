...
class IntegrationTest_Chapters_MultipleFacet {
  ...
  void testRenameChapterAttachments() {
    System.out.println("Test (7) : Rename single attachment, reference, and footnote inchapter");
  ...
  // Tests 32-34 covered in tests 19, 23, 24 // Tests 37-41 skipped - copy with notes/secondary
