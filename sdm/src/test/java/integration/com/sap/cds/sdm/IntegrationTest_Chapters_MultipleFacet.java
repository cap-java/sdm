...
class IntegrationTest_Chapters_MultipleFacet {
  ...
  //   System.out.println("Test (7) : Rename single attachment, reference, and footnote in
  // chapter");
  ...
  //         response =
  //             api.renameAttachment(appUrl, chapterEntityName, facet[i], chapterID, ID[i],
  // name[i]);
  ...
  // attachments. Kindly contact the admin\\n\\nTable: references\\nPage:
  // IntegrationTestEntity\",\"numericSeverity\":3},{\"code\":\"<none>\",\"message\":\"Could not
  // update the following files. \\n\\n\\t\\u2022 unique_sample1\\n\\nYou do not have the required
  // permissions to update attachments. Kindly contact the admin\\n\\nTable: attachments\\nPage:
  // IntegrationTestEntity\",\"numericSeverity\":3},{\"code\":\"<none>\",\"message\":\"Could not
  // update the following files. \\n\\n\\t\\u2022 unique_sample1\\n\\nYou do not have the required
  // permissions to update attachments. Kindly contact the admin\\n\\nTable: footnotes\\nPage:
  // IntegrationTestEntity\",\"numericSeverity\":3}]";
  ...
  //       System.out.println(
  //           "tempID[0]: " + tempID[0] + ", tempID[1]: " + tempID[1] + ", tempID[2]: " +
  // tempID[2]);
  ...
  //   if (!testStatus) {
  //     fail(
  //         "Could not update secondary properties in chapter before book save. Counter: " +
  // counter);
  //   }
  // }
  ...
  //     String chapterResponse =
  //         apiNoRoles.createEntityDraft(appUrl, chapterEntityName, entityName2, srvpath,
  // tempBookID);
  //     if (!chapterResponse.equals("Could not create entity")) {
  //       String tempChapterID = chapterResponse;
  ...
  //     }
  //   }
  //   if (!testStatus) fail("Could not update secondary properties in chapter after book is
  // saved");
  // }
  ...
  //       for (int i = 0; i < facet.length; i++) {
  //         tempID[i] =
  //             CreateandReturnFacetID(appUrl, serviceName, tempChapterID, facet[i], postData,
  // file);
  //         if (tempID[i] != null) {
  //           createCounter++;
  //         }
  ...
  //                   appUrl, chapterEntityName, facet[i], tempChapterID, tempID[i],
  // invalidProperty);
  ...
  //                 api.fetchMetadata(appUrl, chapterEntityName, facet[i], tempChapterID,
  // tempID[i]);
  ...
  //   if (!testStatus) {
  //     fail("Failed to upload multiple chapter facet entries, delete one per facet and save
  // book");
  //   }
  // }
  ...
  //     throws IOException {
  //   System.out.println(
  //       "Test (25): Rename & Update secondary properties for multiple chapter attachments after
  // book is saved");
  ...
  //               && "Updated".equals(upd4)) {
  //             Updated1[i] = true;
  //             System.out.println("Renamed & updated Secondary properties for " + facet[i] + "
  // PDF");
  //           }
  //         }
  ...
  //           String upd1 =
  //               api.updateSecondaryProperty(
  //                   appUrl, chapterEntityName, facet[i], tempChapterID, exeID[i],
  // bodyDropdownExe);
  //           String upd2 =
  //               api.updateSecondaryProperty(
  ...
  //             testStatus = true;
  //             System.out.println("Renamed & updated Secondary properties for chapter
  // attachments");
  //           }
  //         }
  //       }
  ...
  //         String updInvalid =
  //             api.updateInvalidSecondaryProperty(
  //                 appUrl, chapterEntityName, facet[i], tempChapterID, pdfID[i],
  // invalidPropertyPDF);
  ...
  //           testStatus = true;
  //           System.out.println(
  //               "Rename & update unsuccessful for invalid properties and successful for valid
  // attachments");
  //         }
  //       }
  //     }
  ...
  // attachments after book is saved");
  ...
  //         // Parse JSON response to check for invalid secondary property errors in all three
  // tables
  //         ObjectMapper mapper = new ObjectMapper();
  //         JsonNode root = mapper.readTree(response);
  //         boolean hasAttachmentsError = false;
  ...
  //           testStatus = true;
  //           System.out.println(
  //               "Rename & update unsuccessful for invalid Secondary properties and successful for
  ...
  //         api.createLink(
  //             appUrl, chapterEntityName, facetName, createLinkChapterID, linkName + "1",
  // linkUrl);
  ...
  //       List<String> createResponse =
  //           api.createAttachment(
  //               appUrl, chapterEntityName, facet[i], sourceChapterID, srvpath, postData,
  // tempFile);
  ...
  //     String copyResponse =
  //         api.copyAttachment(appUrl, chapterEntityName, facetName, targetChapterID,
  // facetObjectIds);
  ...
  //       fail("Expected 2 attachments in facet " + facetName + ", found " +
  // targetMetadata.size());
  //     }
  //     for (Map<String, Object> meta : targetMetadata) {
  //       String attachmentId = (String) meta.get("ID");
  //       String readResponse =
  //           api.readAttachment(appUrl, chapterEntityName, facetName, targetChapterID,
  // attachmentId);
  ...
  //   copyAttachmentSourceBook = api.createEntityDraft(appUrl, bookEntityName, entityName2,
  // srvpath);
  ...
  //   copyAttachmentTargetBook = api.createEntityDraft(appUrl, bookEntityName, entityName2,
  // srvpath);
  ...
  //     // Save Book2
  //     saveResponse = api.saveEntityDraft(appUrl, bookEntityName, srvpath,
  ...
  //     File tempFile =
  //         File.createTempFile("test37_note_" + facet[i] + "_" + System.currentTimeMillis(),
  // ".pdf");
  //     tempFile.deleteOnExit();
  //     java.nio.file.Files.copy(
  //         originalPdf.toPath(),
  ...
  //   for (int i = 0; i < facet.length; i++) {
  //     List<Map<String, Object>> targetMetadata =
  //         api.fetchEntityMetadata(appUrl, chapterEntityName, facet[i],
  // copyAttachmentTargetChapter);
  ...
  //     // Update secondary properties using RequestBody (customProperty6 - Boolean,
  // customProperty2 -
  //     // Integer)
  ...
  //   // Edit target book
  //   editResponse = api.editEntityDraft(appUrl, bookEntityName, srvpath,
  // copyAttachmentTargetBook);
  //   if (!editResponse.equals("Entity in draft mode")) {
  ...
  //   System.out.println("Test 39 passed - both note and secondary properties checked during
  // copy");
  // }
  ...
  //       api.copyAttachment(appUrl, chapterEntityName, facetName, testChapterID,
  // invalidObjectIds);
  ...
  //   java.nio.file.Files.copy(
  //       originalPdf.toPath(), tempPdf.toPath(),
  // java.nio.file.StandardCopyOption.REPLACE_EXISTING);
  //   java.nio.file.Files.copy(
  //       originalTxt.toPath(), tempTxt.toPath(),
  // java.nio.file.StandardCopyOption.REPLACE_EXISTING);
  ...
  //     String copyResponse =
  //         api.copyAttachment(appUrl, chapterEntityName, facet[i], targetChapterID,
  // objectIdsToCopy);
  //     if (!copyResponse.equals("Attachments copied successfully")) {
  //       fail("Could not copy attachment to facet: " + facet[i]);
  //     }
  ...
  //     try {
  //       api.editLink(
  //           appUrl, chapterEntityName, facetName, testChapterID, linkId,
  // "https://editedexample");
  ...
  //   String editResponse = apiNoRoles.editEntityDraft(appUrl, bookEntityName, srvpath,
  // testBookID);
  //   if (!editResponse.equals("Entity in draft mode")) {
  //     fail("Could not edit book");
  //   }
  ...
  //     String createLinkResponse =
  //         api.createLink(appUrl, chapterEntityName, facet[i], sourceChapterID, linkName,
  // linkUrl);
  //     if (!createLinkResponse.equals("Link created successfully")) {
  ...
  //     } catch (IOException e) {
  //       System.out.println("Expected error received for invalid object ID in facet " +
  // facetName);
  //     }
  //   }
  ...
  //   System.out.println("Test (61): Changelog after modifying note and custom property in
  // chapter");
  ...
  //     RequestBody bodyInt =
  //         RequestBody.create(MediaType.parse("application/json"), "{\"customProperty2\":
  // 12345}");
  //     api.updateSecondaryProperty(
  ...
  //   ClassLoader classLoader = getClass().getClassLoader();
  //   File originalFile = new File(classLoader.getResource("sample.txt").getFile());
  //   File tempFile = File.createTempFile("changelog_test63_" + System.currentTimeMillis(),
  // ".txt");
  //   tempFile.deleteOnExit();
  //   java.nio.file.Files.copy(
  //       originalFile.toPath(),
  ...
  //   ClassLoader classLoader = getClass().getClassLoader();
  //   File originalFile = new File(classLoader.getResource("sample.txt").getFile());
  //   File tempFile = File.createTempFile("changelog_test64_" + System.currentTimeMillis(),
  // ".txt");
  //   tempFile.deleteOnExit();
  //   java.nio.file.Files.copy(
  //       originalFile.toPath(),
  ...
  //       Map<String, Object> metadata =
  //           api.fetchMetadata(appUrl, chapterEntityName, facet[i], sourceChapterID,
  // attachmentId);
  //       if (metadata.containsKey("objectId")) {
  ...
  //   List<String> createResponse =
  //       api.createAttachment(
  //           appUrl, chapterEntityName, facet[0], sourceChapterID, srvpath, postData,
  // originalPdf);
  //   if (!createResponse.get(0).equals("Attachment created")) {
  //     fail("Could not create source attachment");
  //   }
  ...
  //   createResponse =
  //       api.createAttachment(
  //           appUrl, chapterEntityName, facet[0], targetChapterID, srvpath, postData,
  // originalPdf);
  //   if (!createResponse.get(0).equals("Attachment created")) {
  ...
  //   Map<String, Object> sourceMetadata =
  //       api.fetchMetadata(appUrl, chapterEntityName, facet[0], sourceChapterID,
  // sourceAttachmentId);
  //   String objectId = sourceMetadata.get("objectId").toString();
  ...
  //   tempFile.deleteOnExit();
  //   java.nio.file.Files.copy(
  //       originalPdf.toPath(), tempFile.toPath(),
  // java.nio.file.StandardCopyOption.REPLACE_EXISTING);
  ...
  //     List<Map<String, Object>> targetMetadata =
  //         api.fetchEntityMetadata(appUrl, chapterEntityName, facet[i], targetChapterID);
  //     assertTrue(targetMetadata.size() >= 1, "Target should have attachment in facet: " +
  // facet[i]);
  //   }
  ...
  //   ClassLoader classLoader = getClass().getClassLoader();
  //   File originalPdf = new File(classLoader.getResource("sample.pdf").getFile());
  //   File tempFile = File.createTempFile("chain_move_test74_" + System.currentTimeMillis(),
  // ".pdf");
  //   tempFile.deleteOnExit();
  //   java.nio.file.Files.copy(
  //       originalPdf.toPath(), tempFile.toPath(),
  ...
  //   System.out.println(
  //       "Test (76) : Rename chapter attachment changing extension from .pdf to .txt across all
  // facets - should return extension change warning");
  ...
  //         api.saveEntityDraft(appUrl, bookEntityName, srvpath, newBookID);
  //     assertNotNull(saveWithWarningResponse, "Response should not be null for facet: " +
  // facet[i]);

  //     String expectedMessage =
  //         "Changing the file extension is not allowed. The file \"renamed_document.txt\" must
  // retain its original extension \".pdf\".";
  ...
  //   System.out.println(
  //       "Test (77) : Upload chapter attachment in draft, rename changing extension before save
  // across all facets - should return extension change warning");
  ...
  //     // Step 2: Upload a PDF attachment to the chapter facet while book is still in draft
  // (unsaved)
  //     ClassLoader classLoader = getClass().getClassLoader();
  //     File file = new File(classLoader.getResource("sample.pdf").getFile());
  ...
  //     // Step 3: Rename the attachment changing extension from .pdf to .txt — book still not
  // saved
  //     String renameResponse =
  //         api.renameAttachment(
  //             appUrl,
