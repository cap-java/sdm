...
class IntegrationTest_MultipleFacet {
  ...
  // \\\"%s\\\" already exists. Rename the object and try again.\\n\\nTable: attachments\\nPage:
  // IntegrationTestEntity\",\"@Common.numericSeverity\":4},{\"code\":\"<none>\",\"message\":\"An
  // object named \\\"%s\\\" already exists. Rename the object and try again.\\n\\nTable:
  // footnotes\\nPage: IntegrationTestEntity\",\"@Common.numericSeverity\":4}]}}",
  ...
  //       response = api.saveEntityDraft(appUrl, entityName, srvpath, entityID);
  //       String expected =
  //           "{\"error\":{\"code\":\"400\",\"message\":\"\\\"note/invalid\\\" contains unsupported
  // characters (‘/’ or ‘\\\\’). Rename and try again.\\n\\nTable: footnotes\\nPage:
  ...
  // to target attachment for all facets");
  //   }
  // }
  ...
  //   System.out.println(
  //       "Test (76) : Rename attachment changing extension from .pdf to .txt across all facets -
  // should return extension change warning");
  ...
  //   // Step 4 & 5: Edit the entity, rename each facet's attachment changing extension .pdf ->
  // .txt
  //   for (int i = 0; i < facet.length; i++) {
  ...
  //   System.out.println(
  //       "Test (77) : Upload attachment in draft, rename changing extension before save across all
  ...
  //     // Step 3: Rename the attachment changing extension from .pdf to .txt — entity still not
  // saved
  //     String renameResponse =
  //         api.renameAttachment(
  //             appUrl, entityName, facet[i], newEntityID, facetAttachmentID,
  // "renamed_document.txt");
  //     if (!"Renamed".equals(renameResponse)) {
  //       api.deleteEntityDraft(appUrl, entityName, newEntityID);
  //       fail("Could not rename attachment on facet " + facet[i] + ": " + renameResponse);
