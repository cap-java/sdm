...
public class VersioningServiceImpl implements VersioningService {
  ...
  public String checkInDocument(
    ...
    builder.addTextBody(
        "major", cmisDocument.getIsMajorVersion().toString(), ContentType.TEXT_PLAIN);
    builder.addTextBody("checkInComment", cmisDocument.getComment(), ContentType.TEXT_PLAIN);
  ...
  public String cancelCheckOut(String repositoryId, SDMCredentials sdmCredentials, String jwtToken, String objectId) {
    ...
    MultipartEntityBuilder builder = MultipartEntityBuilder.create();
    // Add additional form fields
    builder.addTextBody("cmisaction", "cancelCheckOut", ContentType.TEXT_PLAIN);
    builder.addTextBody("objectId", objectId, ContentType.TEXT_PLAIN);
    builder.addTextBody("includeAllowableActions", "true", ContentType.TEXT_PLAIN);
    builder.addTextBody("succinct", "true", ContentType.TEXT_PLAIN);
    HttpEntity multipart = builder.build();
  ...
  public String setContentStream(
    ...
    builder.addTextBody("objectId", cmisDocument.getPwcobjectId(), ContentType.TEXT_PLAIN);
