...
public class CacheConfig {
  ...
  private static Cache<SecondaryTypeKey, List<String>> secondaryTypePropertiesCache;
  ...
  public static Cache<SecondaryTypeKey, List<String>> getSecondaryTypePropertiesCache() {
